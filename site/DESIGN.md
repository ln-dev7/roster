<!--
  Design reference for this site: the Linear marketing-system analysis
  from getdesign.md / VoltAgent awesome-design-md (MIT).
  Source: https://github.com/VoltAgent/awesome-design-md (design-md/linear.app)
  Roster keeps the structure (surfaces, hairlines, type scale, spacing)
  and swaps the palette for its own blueprint identity — see app/globals.css.
-->
